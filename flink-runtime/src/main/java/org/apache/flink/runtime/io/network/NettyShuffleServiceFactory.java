...
public class NettyShuffleServiceFactory
    ...
    static NettyShuffleEnvironment createNettyShuffleEnvironment(
        ...
        // 创建 NettyConnectionManager
        // 在创建 NettyConnectionManager 过程中创建 netty server 和 netty client
